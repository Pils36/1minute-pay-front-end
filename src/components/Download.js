            ...
            <div className="web">
              <div className="row  ">
                <div className="col-12 col-md-6 web-box order-2 order-sm-2 order-md-1 order-lg-1 ">
                  ...
                  <div className="download-header">Web View Trading</div>
                  <div className="download-text">
                    We have made our beautiful services available via our
                    web-app for those who want to use the platform via browser.
                  </div>
                </div>
                <div className="col-6 col-md-6 order-1 order-sm-1 order-md-2 order-lg-2 py-sm-5 px-0">
            ...
            <div className="mobile">
              <div className="row ">
                <div className="col-12 col-sm-12 col-md-6 mobile-box">
                  ...
                  <div className="download-header">Mobile App Trading</div>
                  <div className="download-text">
                    Ofcourse we also created an amazing mobile application for
                    you to use on the go, we mean it, the same speed anytime,
                    anywhere.
                  </div>

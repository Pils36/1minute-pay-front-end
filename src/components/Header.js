...
function Header(props) {
  ...
  return (
    <div className="header">
      {props.children}
        {loading &&
          <Lottie options={defaultOptions} width="100%" height="600px" />}
            <video onLoadedData={()=> setLoading(false) } preload="auto" muted autoPlay loop  className="bg-header">
                  ...
                  <div className="col-12 col-sm-12 col-md-10 col-lg-8 m-auto">
                    <div className="container">
                      <div className="main-header d-none d-md-block">
                        Making Money in the Digital <br /> Space doesn’t have to
                        be <br /> slow.
                      </div>
                      ...
                      <div className="main-text">
                        Get your transactions done and receive <br /> Payments
                        in as quick as One Minute.
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="scroll">
                    <div className="d-flex justify-content-center justify-content-md-start align-items-center">
                      <div className="arrow d-flex justify-content-start align-items-center">
                        <img src={Arrow} alt="" />
                        <div className="scroll-text mx-3">
                          Scroll to move along
                        </div>
                      </div>
                    </div>
                  </div>

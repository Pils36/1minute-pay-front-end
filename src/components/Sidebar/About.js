        ...
        <div className="about-box">
          ...
          <div className="about-text">
            ...
            <div className="about-body">
              ...
              <div className="lead">
                We buy gift cards and bitcoins and in return we pay you the
                Naira Value in just one minute.
              </div>
              <div className="lead">
                Our reliable instant cash remittance has earned us repeated
                transactions from customers across the world.
              </div>
            </div>
          </div>
        </div>
